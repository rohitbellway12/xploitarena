...
import { Users, ChevronLeft, ChevronRight, Search, ShieldCheck, X, Mail, Calendar, FileText, Award } from 'lucide-react';
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm text-[hsl(var(--text-main))] divide-y divide-[hsl(var(--border-subtle))]">
                {loading ? (
                  ...
                  currentItems.map((r) => (
                    <tr key={r.id} className="hover:bg-[hsl(var(--text-main))]/[0.02] transition-colors group">
                      <td className="p-4">
